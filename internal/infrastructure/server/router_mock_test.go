...
// Source: internal/infrastructure/router/router.go
...
func (m *MockRouter) Listen(ln net.Listener) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Listen", ln)
	ret0, _ := ret[0].(error)
	return ret0
}

// Listen indicates an expected call of Listen
func (mr *MockRouterMockRecorder) Listen(ln interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Listen", reflect.TypeOf((*MockRouter)(nil).Listen), ln)
}
